/*
 * EfficientSignedReciprocityCoverageExperiment.cpp
 *
 *  Created on: Oct 27, 2010
 *      Author: duyvu
 */

#include "EfficientSignedReciprocityCoverageExperiment.h"
...
EfficientSignedReciprocityCoverageExperiment::EfficientSignedReciprocityCoverageExperiment() {
...
void EfficientSignedReciprocityCoverageExperiment::normalizeDyadProbs() {
...
int EfficientSignedReciprocityCoverageExperiment::generateDyadicValue(
...
void EfficientSignedReciprocityCoverageExperiment::generateSelfBlock(
...
void EfficientSignedReciprocityCoverageExperiment::generateCrossBlock(
...
void EfficientSignedReciprocityCoverageExperiment::generateSample(
		NetworkSparseMatrix& Y, UnsignedIntVector& Z) {

	cout << "EfficientSignedReciprocityCoverageExperiment::generateSample"
			<< endl;
	...
	//			edgeCount += abs(*i2);
	//	}
	//	cout << "Num of edges is " << edgeCount << endl;
